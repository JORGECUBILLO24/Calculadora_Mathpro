...
class MenuElegante(QWidget):
    ...
    # (1) RUTAS DE IMAGEN
    TOPBAR_LOGO = r"C:\Users\Isaac Mora\OneDrive\Documentos\algreba lineal\Calculadora\Calculadora_Mathpro\Matematica_Basica\Imagenes\FIA.png"  # ← logo largo (barra superior)
    LOGO_INICIAL = r"C:\Users\Isaac Mora\OneDrive\Documentos\algreba lineal\Calculadora\Calculadora_Mathpro\Matematica_Basica\Imagenes\MaThproLogo.png"  # ← logo central de inicio

    IMG_VIDEOS   = r"C:\Users\Isaac Mora\OneDrive\Documentos\algreba lineal\Calculadora\Calculadora_Mathpro\Matematica_Basica\Imagenes\Videos.png"
    IMG_UAM      = r"C:\Users\Isaac Mora\OneDrive\Documentos\algreba lineal\Calculadora\Calculadora_Mathpro\Matematica_Basica\Imagenes\uam.jpg"
    IMG_BARCA    = r"C:\Users\Isaac Mora\OneDrive\Documentos\algreba lineal\Calculadora\Calculadora_Mathpro\Matematica_Basica\Imagenes\Barca.jpg"
