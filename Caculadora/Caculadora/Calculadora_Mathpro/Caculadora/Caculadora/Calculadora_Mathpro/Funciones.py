...
class CalculadoraFunciones(QWidget):
    def __init__(self):
        ...
        self._construir_pestana_funciones()
    ...
    def _construir_pestana_funciones(self):
        main = QHBoxLayout()
        ...
        self.btn_plot.clicked.connect(self.graficar_funcion)
        ...
        for i, t in enumerate(funciones):
            ...
            btn.clicked.connect(lambda checked, txt=t: self.insertar_texto(txt))
